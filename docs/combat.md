...
- **Wound reset**: Wounds reset to 0 at the start of each round (not cumulative across rounds).
- **Activation**: Simultaneous — all players commit orders, then all orders and combat auto-resolve at once (no active/inactive player turns).
